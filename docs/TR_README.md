...
Üniversiteler arası bu ortak projede, **Matematik Motoru Geliştiricisi**, **Katman Uygulama Uzmanı** ve **Sistem Entegrasyon Sorumlusu** (Entegrasyon & Dökümantasyon) olarak görev aldım[cite: 2]. Temel odak noktam, sinir ağının matematiksel altyapısını oluşturmak ve çalışma zamanındaki (runtime) işleyişini koordine etmekti.
